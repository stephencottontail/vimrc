...
exe "hi! String"          "guifg=".s:green   "guibg=".s:none "gui=".s:none
exe "hi! StringDelimiter" "guifg=".s:green   "guibg=".s:none "gui=".s:none
...
exe "hi! Identifier"      "guifg=".s:blue    "guibg=".s:none "gui=".s:none
exe "hi! Function"        "guifg=".s:blue    "guibg=".s:none "gui=".s:none
...
exe "hi! Exception"       "guifg=".s:red    "guibg=".s:none "gui=".s:none
exe "hi! Comment"         "guifg=".s:yellow "guibg=".s:none "gui=".s:none
